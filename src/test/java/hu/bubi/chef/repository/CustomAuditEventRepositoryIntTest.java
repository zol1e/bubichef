...
import hu.bubi.chef.config.audit.AuditEventConverter;
import hu.bubi.chef.domain.PersistentAuditEvent;
...
import static hu.bubi.chef.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
